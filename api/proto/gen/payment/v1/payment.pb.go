...
const file_payment_v1_payment_proto_rawDesc = "" +
	"\n" +
	"\x18payment/v1/payment.proto\x12\x06pmt.v1\"5\n" +
	"\x11GetPaymentRequest\x12 \n" +
	"\fbiz_trade_no\x18\x01 \x01(\tR\n" +
	"bizTradeNo\"C\n" +
	"\x12GetPaymentResponse\x12-\n" +
	"\x06status\x18\x02 \x01(\x0e2\x15.pmt.v1.PaymentStatusR\x06status\"u\n" +
	"\rPrePayRequest\x12 \n" +
	...
	"\bcode_url\x18\x01 \x01(\tR\acodeUrl*\x8c\x01\n" +
	"\rPaymentStatus\x12\x18\n" +
	"\x14PaymentStatusUnknown\x10\x00\x12\x15\n" +
