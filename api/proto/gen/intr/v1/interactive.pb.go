...
const file_intr_v1_interactive_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x14.intr.v1.InteractiveR\x05value:\x028\x01\"F\n" +
	"\n" +
	"GetRequest\x12\x10\n" +
	"\x03biz\x18\x01 \x01(\tR\x03biz\x12\x14\n" +
	"\x05bizId\x18\x02 \x01(\x03R\x05bizId\x12\x10\n" +
	"\x03uid\x18\x04 \x01(\x03R\x03uid\"\xc1\x01\n" +
	...
	"\x03biz\x18\x01 \x01(\tR\x03biz\x12\x14\n" +
	"\x05bizId\x18\x02 \x01(\x03R\x05bizId\"\x15\n" +
	...
	"\bGetByIds\x12\x18.intr.v1.GetByIdsRequest\x1a\x19.intr.v1.GetByIdsResponseB\x81\x01\n" +
	"\vcom.intr.v1B\x10InteractiveProtoP\x01Z#webook/api/proto/gen/intr/v1;intrv1\xa2\x02\x03IXX\xaa\x02\aIntr.V1\xca\x02\aIntr\\V1\xe2\x02\x13Intr\\V1\\GPBMetadata\xea\x02\bIntr::V1b\x06proto3"
...
var file_intr_v1_interactive_proto_goTypes = []any{
	...
	(*GetResponse)(nil),         // 4: intr.v1.GetResponse
...
var file_intr_v1_interactive_proto_depIdxs = []int32{
	...
	4,  // 13: intr.v1.InteractiveService.Get:output_type -> intr.v1.GetResponse
